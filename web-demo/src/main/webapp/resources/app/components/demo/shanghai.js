webModule.component("demoShanghai",{
    templateUrl: 'resources/app/partials/demo/shanghai.html',
    bindings:{$router:'<'},
    controller: function($scope,$timeout,Restangular,$rootRouter,$location) {
        ...
        $ctrl.getColumnAndData = function(){
            ...
            $ctrl.fields = [
                {"id":1,"group":0,"type":"SRV","field":"id","api":"model","title":"型号","order":2,"show":true,"edit":false,"source":0,"count":false},
                {"id":2,"group":0,"type":"SRV","field":"loginName","api":"vendor","title":"厂商","order":3,"show":true,"edit":false,"source":0,"count":false},
                {"id":3,"group":0,"type":"SRV","field":"name","api":"cpu_model","title":"CPU型号","order":4,"show":true,"edit":false,"source":0,"count":false},
                {"id":4,"group":0,"type":"SRV","field":"password","api":"cpu_cores","title":"CPU核数","order":5,"show":true,"edit":false,"source":0,"count":false},
                {"id":1,"group":0,"type":"SRV","field":"id","api":"model","title":"型号","order":2,"show":true,"edit":false,"source":0,"count":false},
                {"id":2,"group":0,"type":"SRV","field":"loginName","api":"vendor","title":"厂商","order":3,"show":true,"edit":false,"source":0,"count":false},
                {"id":3,"group":0,"type":"SRV","field":"name","api":"cpu_model","title":"CPU型号","order":4,"show":true,"edit":false,"source":0,"count":false},
                {"id":4,"group":0,"type":"SRV","field":"password","api":"cpu_cores","title":"CPU核数","order":5,"show":true,"edit":false,"source":0,"count":false},
            ...
            $ctrl.fieldsCopy = angular.copy($ctrl.fields);
            //var dataSort = $ctrl.fields.sort(compare("order"));
            //$ctrl.fields.push({title: "资产编号",  field: "code",order:1});
