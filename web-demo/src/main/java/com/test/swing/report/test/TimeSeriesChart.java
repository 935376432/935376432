...
public class TimeSeriesChart {
    ...
    public TimeSeriesChart() {
        ...
        JFreeChart jfreechart =
            ChartFactory.createTimeSeriesChart("告警信息展示图", "数量", "价格", xydataset, true, true, true);
        ...
        xyplot.setBackgroundPaint(Color.decode("#f1f1f1"));
