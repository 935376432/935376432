...
public class JMenuDemo extends JFrame {
    ...
    public JMenuDemo() {
        ...
        fileMenu.addSeparator();
        fileMenu.add(createMenuItem("Save", "s", new ImageIcon("resources\\icon\\Save.png"), KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.CTRL_MASK)));
        fileMenu.add(createMenuItem("Save As", "a", new ImageIcon("resources\\icon\\SaveAs.png"), null));
        fileMenu.add(createMenuItem("Save All", "e", new ImageIcon("resources\\icon\\SaveAll.png"), KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK)));
        ...
        JMenuItem menuNamedRename = createMenuItem("Rename", "m", new ImageIcon("resources\\icon\\Rename.png"), KeyStroke.getKeyStroke("F2"));
        ...
        fileMenu.addSeparator();
        fileMenu.add(createMenuItem("Import", "i", new ImageIcon("resources\\icon\\Import.png"), null));
        fileMenu.add(createMenuItem("Export", "o", new ImageIcon("resources\\icon\\Export.png"), null));
        fileMenu.addSeparator();
