...
public class DatagramChannelServerDemo {
    ...
    /*
     * 接收 用receive()读IO 作为服务端一般不需要调用connect()，如果未调用<span
     * style="font-family: Arial, Helvetica, sans-serif;">connect()时调</span><
     * span
     * style="font-family: Arial, Helvetica, sans-serif;">用read()\write()读写，
     * 会报java.nio.channels</span> .NotYetConnectedException
    ...
    synchronized public void reveice(SelectionKey key) throws IOException {
        ...
        System.out.println(content.trim() + sc.getRemoteAddress());
